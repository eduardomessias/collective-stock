...
const Sidebar = () => 
    <nav className={styles.sidebar + " w3-sidebar w3-collapse w3-white w3-animate-left"} id="mySidebar">
        <br />
        <div className="w3-container w3-row">
            <div className="w3-col s4">
                <Image src="/w3images/avatar2.png" className="w3-circle w3-margin-right" width={46} height={46} />
            </div>
